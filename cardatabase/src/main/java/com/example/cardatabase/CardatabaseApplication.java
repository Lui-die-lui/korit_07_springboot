...
public class CardatabaseApplication  implements CommandLineRunner {
	...
	// 여기 생성자 주입 부분 적겠습니다.(md파일과도 동일하게 보기)
	...
	// CommandLineRunner 인터페이스의 추상메서드읜 run() 을 여기서 구현
	@Override
	public void run(String... args) throws Exception {
		// 내부에서 CarRepository의 객체인 repository 의 메서드를 호출할겁니다.
		...
		// -> 이상의 코드는 testdb내의 Car 태이블 내에 3개의 row를 추가하여 저장한다는 의미
		// Java 기준으로는 객체 3 개를 만들었다고 볼 수 있음
